...
<body>
<div class="container">
    <form:form class="well form-horizontal" action="../${taskId}" method="PUT" id="contact_form">
        <fieldset>
            <div>
                <h2><b>Edit your task</b></h2>
            </div>
            <br>
            <div class="form-group">
                ...
                <div class="col-md-4 inputGroupContainer">
                    <div class="input-group">
                        ...
                        <input name="taskName" value="${task.taskName}" class="form-control" type="text">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4 inputGroupContainer">
                    <div class="input-group">
                        <span class="input-group-addon"></span>
                        <input name="deadline" value="${task.deadline}" class="form-control" type="date">
                    </div>
                </div>
            </div>
